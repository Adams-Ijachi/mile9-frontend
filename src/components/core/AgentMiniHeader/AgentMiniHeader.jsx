...
const AgentMiniHeader = () => {
  ...
  console.log('Details;', agentDetails)
          ...
          <nav className="navbar navbar-expand">
            <div className="collapse navbar-collapse justify-content-between">
              ...
              <ul className="navbar-nav header-right">
                <li className="nav-item pointer" title="Your Wallet Balance">
                  <div className="d-flex">
                    <IoWallet size={25} className="text-muted mr-2" />
                    <span className="text-muted balance font-w500">Balance: <span className="ml-2">₦{_.get(agentDetails, 'agent_wallet_amount', null)}</span></span>
                  </div>
                </li>
